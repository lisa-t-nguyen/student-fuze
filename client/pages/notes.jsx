      ...
      >
        <Box sx={{ marginLeft: 3, marginTop: 3 }}>
          <Stack direction="row" spacing={2} sx={{ display: 'flex', alignItems: 'center', marginBottom: 0.5 }}>
            ...
            <h2 style={{ fontFamily: 'Poppins' }}>Notes</h2>
          </Stack>
        </Box>
        ...
        <Box container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} sx={{ marginTop: 2, marginLeft: 2, marginRight: 2 }}>
          ...
          <Typography variant="h7" sx={{ fontFamily: 'Poppins', fontWeight: 'bolder' }}>Presenting Concerns</Typography>
          <Grid2>
            <TextField
              id="outlined-helperText"
              label="Strengths"
              defaultValue="Notes"
              helperText="Date / Submitted by:"
